import type { WsServerInstance, Message, DataFormat } from '../types';
import InstanceCard from './InstanceCard';
import ChatPanel from './ChatPanel';
import './ProxyTab.css';

interface WsServerTabProps {
  instances: WsServerInstance[];
  selectedId: string | null;
  onSelect: (id: string) => void;
  onAdd: () => void;
  onDelete: (id: string) => void;
  onUpdate: (id: string, updates: Partial<WsServerInstance>) => void;
...
export default function WsServerTab({
  instances,
  selectedId,
  onSelect,
  onAdd,
    ...
    <div className="tab-container">
      ...
      <div className="tab-content">
        {selectedInstance ? (
          ...
          <div className="empty-state">选择或创建一个 WebSocket 服务端</div>
        )}
      </div>
    </div>
  );
